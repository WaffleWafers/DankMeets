...
echo ': <br />'.
 $this->lsite['name'].': <input type="text" name="chatuser" id="chatuser" size="12" maxlength="12" value="'.$_SESSION['username'].'" readonly/>
 <input style="visibility: hidden" type="text" name="cod" id="cod" size="4" maxlength="4" /> &nbsp;
...
-->
  ...
  <input type="submit" style="visibility:hidden" value="<?php echo $this->lsite['chat']; ?>" id="submit"/>

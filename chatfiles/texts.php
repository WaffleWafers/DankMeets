...
$en_site = array(
  ...
  'name'=>'Name',
  'code'=>'Code',
  'addnmcd'=>'Enter a name',
  'chatlogged'=>'<h4 id="chlogged">To talk in chat, you must be logged in.</h4>',
  'online'=>'Online',
  'no1online'=>'- No one online',
  'loadroom'=>'<h3>Loading Chat Room</h3>',
  ...
  'err_vcode'=>'Incorrect verification code',
  'err_textchat'=>'The text must contain between 2 and 90 characters',
